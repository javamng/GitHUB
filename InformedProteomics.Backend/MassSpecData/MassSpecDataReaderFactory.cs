    ...
    public static class MassSpecDataReaderFactory
    {
        ...
        private static string FilterStringAll
        {
            get
            {
                ...
                return "All Supported Spectrum Files|*.raw;*.mzML;*.mzML.gz;*.mzXML;*.mzXML.gz;*.mgf;*.mgf.gz;*.d;mspeak.bin;msprofile.bin;*.wiff;*.d;*.u2;FID;analysis.yep;analysis.baf;*.raw;_extern.inf;_inlet.inf;_FUNC*.DAT;*.lcd;*.pbf"
                       + "|Thermo .RAW|*.raw"
